...
function syncOpponent() {
  onValue(ref(db, "rooms/"+roomId), snap => {
    ...
    let opponentCards = isPlayer1 ? data.p2.played : data.p1.played;
    renderOpponent(opponentCards);
  });
}
...
document.getElementById("play").onclick = async () => {
  ...
  const path = isPlayer1 ? "p1/played" : "p2/played";
